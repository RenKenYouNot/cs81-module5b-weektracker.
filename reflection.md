...
.filter() was the most useful because I used it in almost every function to narrow down my data before doing any analysis. It made it easy to focus only on the entries I cared about.
